...
angular.module('knock2winApp')
  .controller('GameCtrl', ['$scope', '$state', function ($scope, $state) {
    ...
    $scope.banners = [{ logoURL: '/banners/logo-ee.png', clickTag: 'http://shop.ee.co.uk/lg-g2-group/pay-monthly/details/' },
                     { logoURL: '/banners/logo-carphonewarehouse.png', clickTag: 'http://www.carphonewarehouse.com/mobiles/mobile-phones/LG_G2/MONTHLY?colourCode=WHITE' },
                     { logoURL: '/banners/logo-o2.png', clickTag: 'https://www.o2.co.uk/shop/phones/lg/g2/' },
                     { logoURL: '/banners/logo-3.png', clickTag: 'http://www.three.co.uk/Discover/Devices/LG/G2' }];
